...
class NeuralNetwork(nn.Module):
    def __init__(self, wires=8 , embedings = 1):
        ...
        self.realmu = nn.Sequential(
            FilterLinear(1024, 2 ** len(self.wires)),
...
def test(dataloader, model, loss_fn,noise=False,t=0):
    size = len(dataloader.dataset)
    ...
    for i in range(10):
        ...
        plt.suptitle("Noise: "+ str(noise)+ " Epoch: "+str(t)+" img "+str(i))

        plt.savefig(path+"Noise "+ str(noise)+" Epoch "+str(t)+" img "+str(i)+".png")
        plt.show()
...
for t in range(epochs):
    ...
    test(val_dataloader, model, loss_fn,t=t)
print("Done!")
...
for t in range(epochs):
    ...
    test(val_dataloader, model, loss_fn,noise=True,t=t)
print("Done!")
