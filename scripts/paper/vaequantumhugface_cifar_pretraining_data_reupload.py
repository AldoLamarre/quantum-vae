...
DEFAULT_CONFIG = ROOT / "configs" / "paper" / "vaequantumhugface_cifar_pretraining_data_reupload.json"


def main(config_path: str | Path | None = None) -> None:
    parser = argparse.ArgumentParser(description="Run the paper CIFAR-10 data-reupload VAE experiment.")
